            ...
            child: ListView(
              ...
              children: [
                ...
                _section(
                  ...
                  children: const [
                    _P('Alerte (rouge) : SOS déclenché — urgence immédiate.'),
                    _P('Vigilance (orange) : signalement communautaire (vol, agression…).'),
                    _P('Danger (rouge confirmé) : 3 confirmations ou plus par la communauté.'),
                    _P('Sûr (vert) : zone sans incident actif récent après résolution.'),
