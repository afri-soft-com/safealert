...
class _HistoryScreenState extends State<HistoryScreen> {
          ...
          : hp.history.isEmpty
              ? Center(
                  child: Column(
                    ...
                    children: [
                      Text(hp.isOffline ? 'Données non disponibles hors-ligne' : 'Aucun incident',
              ...
              : RefreshIndicator(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, i) {
                      ...
                      return ListTile(
                        leading: Text(hp.typeIcon(item['incident_type'] as String?),
                            style: const TextStyle(fontSize: 24)),
                        title: Text(_typeLabel(item['incident_type'] as String?),
  ...
  String _typeLabel(String? type) {
    switch (type) {
      ...
      case 'sos_discret': return 'SOS Discret';
      case 'vol': return 'Vol';
