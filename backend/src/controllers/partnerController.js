...
const registerPartner = async (req, res) => {
  ...
  try {
    ...
    const result = await pool.query(
      `INSERT INTO partner_api_keys (partner_name, api_key) VALUES ($1, $2) RETURNING *`,
      [partner_name, apiKey]
    );
...
module.exports = { registerPartner, getPublicStats, getPublicIncidents, getPublicHeatmap };